...
class Location(Base):
    ...
    site_num: Mapped[int] = mapped_column(Integer, primary_key=True)
    ...
    address_num: Mapped[int] = mapped_column("ADDRESS NUMBER", Integer, nullable=False)
    ...
    zipcode: Mapped[str] = mapped_column("ZIP CODE", String(15), nullable=False)
