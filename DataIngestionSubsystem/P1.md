...
- A short demo and code repository are shared for review.(Friday the 13th!)
...
### User Stories:
- Read File: Currectly set file to DataFrame with correct rows and columns
- Validate data: Check all data fits correct format
- Clean data: Remove duplicates, fill/remove null values
- Connect to PostgreSQL: Use squl_connection.py to establish core connection
- Manage database: Establish functions for editing and retrieving info from SQL database
- Estalish logging: Use logger.py to establish core logging functionality
- Write exceptions: Name exceptions for different scenarios specific to this project
- Throw and handle exceptions: Handle exceptions within different functions 