...
testString = "This is a test sentence, with punctuation and multiple spaces between some words. I'm adding a sentence with a stopword at the end me. The Dr. went to the river."
testString = tokenize(testString)
print(remove_stopwords(testString))
